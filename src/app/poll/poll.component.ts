...
export class PollComponent implements OnInit {
  ...
  polls!:Poll[];
  constructor(private service : PollService, private primeNGConfig : PrimeNGConfig, private route : Router,private userService: UserServiceService) { } //declaring PollService type of variable for accesing the getPoll() method which will return available polls via get method
